...
('Paragraph', '240 Gigabyte Solid State Drive16 Gigabytes of RamFresh Windows 10 Install', '008'),
('Paragraph', 'Fresh Windows InstallDisk CleanupWindows Optomisation', '009'),
('Paragraph', 'Regular CleanupDisk DefragmentationClean Regristry', '010'),
('Heading', 'Products', '011'),
('Paragraph', 'ThinkCentre M920 SFF $1599', '012'),
